...
public class CheckoutYourInfo {
    ...
    public void userInputFirstName() {
        driver.findElement(By.id("first-name")).sendKeys("Yusriyah");
    }

    @And("User input last name")
    public void userInputLastName() {
        driver.findElement(By.id("last-name")).sendKeys("IM");
    }

    @And("User input postal code")
    public void userInputPostalCode() {
        driver.findElement(By.id("postal-code")).sendKeys("55571");
    }
